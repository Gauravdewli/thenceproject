...
import cross from "../../Assets/image copy 7.png";
    ...
    <div className="flex flex-col gap-10">
      ...
      <div className="flex flex-col items-center gap-10">
        <div className="flex flex-col items-center ">
          ...
          <div className="text-[56px] max-w-[600px] text-center leading-[67px]">
        ...
        <div className="flex flex-col gap-10">
          <div className="flex flex-col gap-4">
            <div>
              <input
                ...
                className={`box-border w-[370px] py-5 text-start p-5 rounded-[50px] ${
                  submitted && name ? "bg-[#f5f8ff]" : "bg-[#EFEFEF]"
                }`}
              />
            </div>
            <div>
              <input
                ...
                className={`box-border w-[370px] py-5 text-start p-5 rounded-[50px] ${
                  submitted && email ? "bg-[#f5f8ff]" : "bg-[#EFEFEF]"
          ...
          <div>
            <Link to={"/pages/congratulationpage/congratulationpage"}>
              <button
                onClick={handleSubmit}
                className={`box-border w-[370px] py-5 text-white text-center p-5 rounded-[50px] ${
                  (name && submitted) || (name && email)
                    ? "bg-black"
                    : "bg-[#C9C9C9]"
                }`}
              >
