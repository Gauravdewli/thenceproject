...
import img2 from "../../Assets/image copy 9.png";

const Congratulation = () => {
  const [countdown, setCountdown] = useState(5); // Initial countdown value

  // useEffect hook to update countdown and redirect after specified time
  useEffect(() => {
    const redirectTimer = setTimeout(() => {
      // Redirect to home link after countdown reaches 0
    ...
    <div className="flex flex-col justify-between gap-10 ">
      ...
      <div className="flex flex-col items-center justify-center gap-10 m-auto mt-[10%]">
        ...
        <div className="flex flex-col items-center justify-center">
          <div>
            <img src={img2} alt="" className="w-[230px]" />
          </div>
          <div className="text-[56px]">Congratulations</div>
          <div className="text-[#727272] text-[27px] max-w-[620px] leading-[35px] text-center">
      ...
      <div className="flex items-baseline gap-1 justify-center mt-[10%]">
        {" "}
        Redirecting you to Homepage in <p className="font-bold">
          {countdown}
        </p>{" "}
        {countdown === 1
          ? "Second"
